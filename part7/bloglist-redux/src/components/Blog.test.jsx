...
describe("Blog component tests", () => {
  ...
  test("renders title and author before clicking view", () => {
    ...
    expect(whenHiddenDiv).not.toHaveTextContent(initialBlog.url);

    expect(whenHiddenDiv).not.toHaveTextContent(`likes: ${initialBlog.likes}`);
  });
  ...
  test("renders url and blog after clicking view", () => {
    ...
    expect(whenVisibleDiv).toHaveTextContent(initialBlog.url);

    expect(whenVisibleDiv).toHaveTextContent(`likes: ${initialBlog.likes}`);
  });
